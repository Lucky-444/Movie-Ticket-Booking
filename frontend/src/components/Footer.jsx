import { assets } from "../assets/assets"; // adjust path correctly
const Footer = () => {
    return (
        <footer className="px-6 pt-8 md:px-16 lg:px-36 w-full text-gray-300">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-10">
                <div className="md:max-w-96">
                    <img alt="MyMovieShow" class="h-11" src={assets.logo} />
                    <p className="mt-6 text-sm">
                        MyMovieShow is your ultimate movie ticket booking platform — explore latest releases,
            watch trailers, check showtimes & book your seats seamlessly.
                    </p>
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            <p>+91 98765 43210</p>
                            <p>📧 support@mymovieshow.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <p className="pt-4 text-center text-sm pb-5">
                Copyright {new Date().getFullYear()} © MyMovieShow. All Right Reserved.
            </p>
        </footer>
    )
}
